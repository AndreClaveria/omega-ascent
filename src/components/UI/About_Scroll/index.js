  ...
  return (
    <div className={style.container}>
      <Info
        ...
        description="
        Hi there, I'm The_Leon, the leader of the Omega Ascent project. I'm excited to introduce you to our world of animation and 3D.  Our main goal with this project was to have fun and create something that we truly enjoy, and I'm proud to say that it has been a successful journey so far. We've poured countless hours of hard work and dedication into this project, and I hope you'll enjoy it as much as we do.
        As for me, I'm a passionate web developer and designer, with a strong interest in 3D and animation. I'm always eager to learn and improve my skills in these areas, and the Omega Ascent project has provided me with the perfect opportunity to do so. I believe that the combination of web development, design, and 3D/animation is a powerful one, and I'm excited to see where this journey takes us. 
